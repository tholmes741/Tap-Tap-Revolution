...
(function(){
  ...
  Game.prototype.lose = function (ctx) {
    ...
    ctx.fillText('You let a ball past...', 250, 150);
    ctx.font = '30pt Arial';
    ctx.fillText('You Lose!', 250, 200);
    ctx.font = '12pt Arial';
    ctx.fillText("Don't let the colored balls get past you.", 250, 300);
    ctx.fillText('Use the left, down, and right arrow keys for the left, center,', 250, 320);
    ctx.fillText('and right columns respectively.', 250, 340);
    ctx.fillText('Press the propper key as the ball crosses the yellow line', 250, 360);
    ctx.fillText('to stop it from getting past you.', 250, 380);
    ctx.font = '24pt Arial';
