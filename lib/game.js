...
(function(){
  ...
  var Game = Tap.Game = function(ctx) {
    this.ctx = ctx;
    this.dots = [];
    this.score = 0;
    this.lives = 7;
  ...
  Game.prototype.flashRed = function (ctx) {
...
Game.prototype.stars = function (ctx) {
  if (this.lefts) {
    ctx.drawImage(window.star, 55, 565, 60, 60);
    // this.lefts = false;
  }
  if (this.center) {
    ctx.drawImage(window.star, 225, 565, 60, 60);
    // this.center = false;
  }
  if (this.rights) {
    ctx.drawImage(window.star, 400, 565, 60, 60);
    // this.rights = false;
  }
};
