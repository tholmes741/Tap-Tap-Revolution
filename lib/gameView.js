...
(function(){
  ...
  GameView.prototype.instructions = function () {
    ...
    this.ctx.fillText('Use the left, down, and right arrow keys for the left, center,', 250, 320);
    this.ctx.fillText('and right columns respectively.', 250, 340);
    this.ctx.fillText('Press the propper key as the ball crosses the yellow line', 250, 360);
    this.ctx.fillText('to stop it from getting past you.', 250, 380);
